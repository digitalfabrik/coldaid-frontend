...
export default function Description() {
  return (
    <StyledDescription>
      ...
      est sed facilisis. Aliquam dignissim, nisl eget semper molestie, velit
      urna aliquet eros, vel viverra tempus massa ultricies aliquam. Mauris
      imperdiet mi vitae ex sollicitudin pretium. Vestibulum ullamcorper
      porttitor ultrices. Cras at molestie lectus. Nam viverra tempor sapien
      ullamcorper maximus. Lorem ipsum dolor sit amet, consectetur adipiscing
      elit. Duis porttitor molestie purus, vitae iaculis nisl tempus quis.
      Vestibulum cursus, magna et tempus cursus, elit risus mollis nulla, a
      sagittis neque magna eget ex. Donec consectetur in lorem et consequat.
      Mauris sit amet lacinia diam. Aliquam pellentesque tellus volutpat sapien
      scelerisque, in dapibus sapien ultrices. Sed nec hendrerit ligula. Nullam
      ultricies nisi leo, a semper quam maximus vitae. Pellentesque vel diam id
      nulla laoreet porttitor eu nec lorem. Vestibulum vitae lacinia orci.
      Pellentesque tristique nulla sed metus semper lobortis. Aenean auctor id
      est sed facilisis. Aliquam dignissim, nisl eget semper molestie, velit
      urna aliquet eros, vel viverraum dolor sit amet, consectetur adipiscing
      elit. Sed consequat dapibus lacus, eget tempus massa ultricies aliquam.
      Mauris imperdiet mi vitae ex sollicitudin pretium. Vestibulum ullamcorper
      porttitor ultrices. Cras at molestie lectus. Nam viverra tempor sapien
      ullamcorper maximus. Lorem ipsum dolor sit amet, consectetur adipiscing
      elit. Duis porttitor molestie purus, vitae iaculis nisl tempus quis.
      Vestibulum cursus, magna et tempus cursus, elit risus mollis nulla, a
